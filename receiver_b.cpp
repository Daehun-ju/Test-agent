...
constexpr char APP_NAME[] = "hello-receiver-b"; // Changed app name
    ...
    while (!iox::posix::hasTerminationRequested())
    {
        subscriber.take()
            .and_then([&](auto& sample) {
                ...
                std::cout << APP_NAME << " received: '" << sample->message << "'" << std::endl; // Changed output prefix
            ...
            .or_else([](auto& result) {
                ...
                {
                    std::cerr << APP_NAME << " Error: Failed to take sample. Error code: " // Changed output prefix
